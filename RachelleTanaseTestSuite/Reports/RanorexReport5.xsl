...
<xsl:output method="html"
							...
							<div> 
							  <xsl:choose>
								<xsl:when test="$itemCount &lt; $maxItems">
													<input type="button" onclick="expandTestcases()" class="exButton" value="Expand Test Cases"  />
								...
								<xsl:otherwise>
								   <input type="button" onclick="expandTestcases()" class="exButton" value="Expand Test Cases"  disabled="disabled"/>
		...
		<li class="{@result} ui-treeList-item" id="testcase{@rid}" onMouseOver="DisplayHoverMenu(this);"  onMouseOut="HideHoverMenu(this)"> 
			...
			<h2 class="{@result}" onclick="OnLoadContentDynamic('{@rid}','testcase',this);" >
				...
				<div class="controls-container testcase" >
					...
					<span class="ui-icon"></span>Jump to Test Case</a>
				</div>
				</xsl:if>
	...
	<div class ="binding">
		<div onclick="showBinding(this)" class="showBinding">      <span class="binding-icon binding-icon-expand"></span><a class="binding-header">Test Data</a></div>
		<div onclick="hideBinding(this)" class="hideBinding binding-hidden"><span class="binding-icon binding-icon-collapse"></span><a class="binding-header">Test Data</a></div>
